...
Comando para gerar modelos de classe baseado nas tabelas.
  ...
  dotnet ef dbcontext scaffold "Server=DESKTOP-PFKHPK4;Database=ImobiliariaDB;Integrated Security=true;TrustServerCertificate=True" Microsoft.EntityFrameworkCore.SqlServer 